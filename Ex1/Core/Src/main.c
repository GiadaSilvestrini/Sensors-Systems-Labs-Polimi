...
void setNote (char* note, int delay, char* colour){
	setFrequency(note);
...
void playRGB(){
	 setNote("sol", (int)TIME_UNIT * 3/8, "red");
	 setNote("la", (int)TIME_UNIT * 3/8, "green");
	 setNote("sol", (int)TIME_UNIT * 3/8, "blue");
}
